...
export default function SponsorInquiry() {
  ...
  const foundingBenefitItemStyle = { background: "rgba(255,255,255,.045)", border: "1px solid rgba(255,107,53,.6)", borderRadius: "14px", padding: "14px 16px", color: "rgba(255,255,255,.9)", fontSize: ".96rem", lineHeight: 1.5, display: "flex", alignItems: "flex-start", gap: "10px" };
