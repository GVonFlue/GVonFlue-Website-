    ...
    <section className="journey" ref={ref}>
      ...
      >
        ...
        >
          ...
          >
            <DrawPath d="M18 196 L282 196" draw={lot} stroke={W} width={3} />
            <DrawPath d="M40 196 L40 188 M260 196 L260 188" draw={lot} stroke={W} width={2} />
            <DrawPath d="M50 196 L50 189 L216 189 L216 196 M126 189 L126 196" draw={found} stroke={W} width={2.6} />
            <DrawPath d="M126 189 L126 110 L214 110 L214 189" draw={frameW} stroke={W} />
            <DrawPath d="M58 189 L58 150 L126 150" draw={frameWing} stroke={W} />
            <DrawPath d="M150 110 L150 189 M178 110 L178 189 M90 150 L90 189" draw={studs} stroke={W} width={2} />
            <DrawPath d="M112 110 L170 56 L228 110" draw={frameR} stroke={W} width={3.6} />
            <DrawPath d="M170 56 L170 110 M141 83 L199 83" draw={rafters} stroke={W} width={2} />
            <DrawPath d="M52 152 L128 128" draw={frameR} stroke={W} width={3.6} />
            <DrawPath d="M198 92 L198 70 L210 70 L210 92" draw={chimney} stroke={W} />
            <DrawPath d="M150 110 L150 80 M190 110 L190 80" draw={battens} stroke={W} width={2.4} />
            <DrawPath d="M161 78 L179 78 L179 96 L161 96 Z" draw={gableWin} stroke={W} width={2.6} />
            <DrawPath d="M148 152 L192 152 M150 152 L150 196 M190 152 L190 196" draw={portico} stroke={W} />
            <DrawPath d="M132 124 L148 124 L148 170 L132 170 Z M140 124 L140 170" draw={winM} stroke={W} width={2.6} />
            <DrawPath d="M192 124 L208 124 L208 170 L192 170 Z M200 124 L200 170" draw={winM} stroke={W} width={2.6} />
            <DrawPath d="M76 162 L104 162 L104 184 L76 184 Z M90 162 L90 184" draw={winW} stroke={W} width={2.6} />
            <DrawPath d="M162 196 L162 153 L178 153 L178 196" draw={door} stroke={W} width={2.8} />
          </svg>
